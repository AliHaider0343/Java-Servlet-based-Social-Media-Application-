                    ...
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            for (var i = 0; i < all_users.length; i++) {
                                ...
                                if (user.user_email !== current_user.user_email && friendShip_status[i]) {
                                    ...
                                    if (friendShip_status[i]) {
                                        ...
                                        content += '<button type="button" class="add-friend-button">Mark as unFriend</button>';
                                        content += '</form>';
                                    }
                                ...
                                addFriendButtons[j].addEventListener('click', function (event) {
                                    ...
                                    xhr.onreadystatechange = function () {
                                        if (xhr.readyState === XMLHttpRequest.DONE) {
                                            ...
                                            alert(message);
                                            window.location.replace("friend_list.jsp");

                                        }
                                    };
                                    xhr.open("POST", "remove_friend_servelet");
